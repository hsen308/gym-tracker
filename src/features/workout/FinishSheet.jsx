    ...
    <Sheet open={open} onClose={onClose}>
      ...
      <div className="field">
        ...
        <textarea
          ...
          rows={3}
          style={{ background: 'var(--surface-alt)', border: '1px solid var(--line)', borderRadius: 'var(--radius)', color: 'var(--text)', padding: 10, fontFamily: 'inherit', fontSize: 15, resize: 'none' }}
        />
      </div>
